...
<!-- Formulaire pour ajouter un user. Dans ce projet les formulaire sont externalisés à l'aide d'une API pour qu'ils puissent être utilisés une infinité de fois, et faciliter la création. L'objet Form représente le formulaire, qui n'est d'autre qu'une liste de champs. Tous les champs des formulaires sont des objets, ils héritent tous de la classe Field. Le contenu des champs est validé grâce à la classe Validator et ses classes filles. La classe FormBuilder est chargée de construire un formulaire et ses filles précisent les spécificités de chacun des formulaires. Le controlleur exécute ensuite le formulaire de son choix. Ici le formulaire d'ajout de user. -->
